...
import { useActionState, useEffect, useState, useTransition, useRef, type RefObject } from "react";
...
export default function PreviewContent({
  ...
  return (
    <>
      ...
      {isCopied && <SuccessParticles buttonRef={copyButtonRef as RefObject<HTMLButtonElement>} />}
      ...
      >
        <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            Live Preview
            <ArrowUpRight
              className={cn("h-4 w-4", "transition-transform duration-200 group-hover:rotate-12")}
            />
          </a>
