...
function EmotionFace({ value }: { value: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Left Eye */}
      <path d={face.eyes.left} stroke={face.color} strokeWidth="2" strokeLinecap="round" />

      {/* Right Eye */}
      <path d={face.eyes.right} stroke={face.color} strokeWidth="2" strokeLinecap="round" />

      {/* Mouth */}
      <path d={face.mouth} stroke={face.color} strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
