...
const defaultTiers: PricingTier[] = [
  {
    ...
    features: ["5 Team Members", "Basic Analytics", "Community Support", "1GB Storage"],
  },
  {
    name: "Pro",
    price: 29,
          ...
          >
            ...
            <div className="p-6 border-b border-zinc-100 dark:border-zinc-800">
              <div className="flex justify-between items-baseline mb-2">
                <h3 className="text-sm font-medium tracking-wide uppercase">{tier.name}</h3>
                {tier.highlight && (
              ...
              <p className="mt-2 text-xs text-zinc-500 dark:text-zinc-400">{tier.description}</p>
            </div>
